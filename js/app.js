...
class SQLVersionApp {
  ...
  initVersionTreeController() {
    this.versionTreeController = new VersionTreeController({
      ...
      sortSelect: document.getElementById('versionSort'),
      dateFromInput: document.getElementById('versionDateFrom'),
      dateToInput: document.getElementById('versionDateTo'),
      authorFilter: document.getElementById('versionAuthorFilter'),
