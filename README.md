...
- 📤 **導出 ZIP** - 將版本歷史打包為 ZIP 檔案
- 📤 **導出 SQL** - 生成包含所有版本的 SQL 檔案
- 📤 **導出 JSON** - 匯出完整的元數據和版本信息
- 📥 **導入功能** - 從 ZIP/JSON 檔案恢復版本歷史
- 📥 **衝突處理** - 智能檢測並處理導入衝突
...
1. **克隆專案**
   ...
   ```bash
   git clone https://github.com/yourusername/SQLScriptManage.git
   cd SQLScriptManage
   ```
...
class ImportExportManager {
  - exportToSQLAndJSON()  // 導出為 SQL 和 JSON
  - downloadAsZip()       // 下載為 ZIP
  - importFromJSON()      // 從 JSON 導入
  - detectConflicts()     // 檢測導入衝突
}
...
如果發現 bug 或有功能建議,請[提交 Issue](https://github.com/yourusername/SQLScriptManage/issues)。
...
- [JSZip](https://stuk.github.io/jszip/) - JavaScript ZIP 庫
...
- 📧 Email: your.email@example.com
- 💬 GitHub Issues: [提交問題](https://github.com/yourusername/SQLScriptManage/issues)
- 📖 Wiki: [查看文檔](https://github.com/yourusername/SQLScriptManage/wiki)
